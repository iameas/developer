...
<body class="d-flex align-items-center py-4 bg-body-tertiary bg-body-tertiar">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="" method="post">
            ...
            <h1 style="margin-top: 20px;" class="h5 mb-3 fw-normal"><span style="font-size:30px;"><strong>Sorry, we
                        can't verify your account at the moment. try again later!</strong></span></h1>

            <div class="form-floating my-3" style="font-size:14px;">
                <a style="font-weight:500;text-decoration:none;font-size:14px;" href="wws.php">
                    Go back to login
                </a>
            </div>
        </form>
